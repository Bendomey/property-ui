  ...
  return (
    <li className="relative">
      ...
      <button
        ...
        onClick={onClick}
        className={clsx(
          "block w-full relative z-10 px-4 py-1 leading-6 sm:text-lg font-medium focus:outline-none transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-offset-white focus-visible:ring-gray-300 hover:text-gray-900",
