        ...
        <div className="min-h-screen bg-white">
          ...
          >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <svg
                className="hidden sm:hidden md:block absolute top-0 right-0 transform -translate-y-16 translate-x-1/2 sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72"
                width="404"
                height="384"
                fill="none"
                viewBox="0 0 404 384"
                  ...
                  <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                    ...
                    >
                      ...
                      <div className="sm:col-span-2 sm:flex sm:justify-end">
                        <button
                          type="submit"
                          className="mt-2 w-full transition duration-300 transform hover:-translate-y-1 hover:scale-110 inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:w-auto"
                        >
                          Submit
                        </button>
                      </div>
